...
This file describes each of the features that are in tidyMeanOfFeatures.txt, a file generated by run_analysis.R


Feature|Description
-------|------------
subjectId|An integer from 1 - 30 (inclusive) identifying the subject that carried out the experiement
activityName|A description of the activity performed by the subject during the experiment.  The activities are walking, walkingUpstairs, walkingDownstairs, sitting, standing, and laying.
